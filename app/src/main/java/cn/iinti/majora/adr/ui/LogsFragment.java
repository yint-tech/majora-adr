...
public class LogsFragment extends Fragment {
    ...
    private final File mFileErrorLog = TheApp.getApplication().getLogFile();
...
*/
    ...
    private void send() {
        Uri uri = FileProvider.getUriForFile(getActivity(), "cn.iinti.majora.adr.fileprovider", mFileErrorLog);
    ...
    private File save() {
        ...
        String filename = String.format(
                "majora_%s_%04d%02d%02d_%02d%02d%02d.log.txt", "error",
